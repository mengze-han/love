...
class RequestApi(object):
    ...
    def gene_request(self, apiname, data, files=None, headers=None):
        ...
        if result["ok"] == 0:
            ...
            texts = self.washdata(result)
            print("_________________________")
            print(texts)
            with open(self.upload_file_path+ ".txt", 'w') as f:
                f.write(str(texts))
            return result
        else:
...
if __name__ == '__main__':
    mp3_list = [r'第39天-正念生活_培育感恩的心.mp3', r'第40天-正念生活_期许和愿景.mp3', r'第32天-正念生活_看见善性.mp3']
    for mp3 in mp3_list:
        print(mp3)
        api = RequestApi(appid="", secret_key="", upload_file_path=mp3)
        api.all_api_request()
